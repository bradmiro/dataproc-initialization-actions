...
This [initialization action](https://cloud.google.com/dataproc/init-actions) installs the latest version of [PyTorch](https://github.com/linkedin/TonY)
on a master node within a [Google Cloud Dataproc](https://cloud.google.com/dataproc) cluster.

## Using this initialization action

This initialization action is intended to install PyTorch[https://pytorch.org/] on a single node. For distributing PyTorch training across multiple nodes, please check out the [TonY initialization action](https://github.com/GoogleCloudPlatform/dataproc-initialization-actions/tree/master/tony).

To utilize GPUs, please 
